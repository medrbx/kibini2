...
def get_items(annee, location, db_conn, c2lDict, indices):
    ...
    # COUNT(IF(i.dateaccessioned > ('2025-01-01' - INTERVAL 1 YEAR), i.itemnumber, NULL)) AS 'nb_exemplaires_créés_dans_annee'               
...
def get_issues(annee, location, db_conn, c2lDict, indices):
    ...
    for idx in prets_pv.index:
        ...
        if idx[4] != '':
            e2025 = p['borrowernumber'][(p['pret_date_pret_annee'] == '2025')
            ...
            e2023 = p['borrowernumber'][(p['pret_date_pret_annee'] == '2023')
                                      ...
                                      & (p['doc_item_collection_lib4'] == idx[3])
                                      & (p['doc_biblio_support'] == idx[4])].nunique()
            ex2025 = p['itemnumber'][(p['pret_date_pret_annee'] == '2025')
                                      & (p['doc_item_collection_lib1'] == idx[0])
                                      & (p['doc_item_collection_lib2'] == idx[1])
                                      & (p['doc_item_collection_lib3'] == idx[2])
                                      & (p['doc_item_collection_lib4'] == idx[3])
    ...
    prets_pv['nb_prets_exemplaires_distincts_2025'] = exemplaires_2025
    
    prets_pv['nb_emprunteurs_distincts_2023'] = emprunteurs_2023
    prets_pv['nb_emprunteurs_distincts_2024'] = emprunteurs_2024
    prets_pv['nb_emprunteurs_distincts_2025'] = emprunteurs_2025    
...
def get_eliminations(annee, location, db_conn, c2lDict, indices):
    ...
    WHERE i.annee_mise_pilon = '2025' AND {location}"""
...
writer = pd.ExcelWriter('../data/Statistiques_collections_2025.xlsx', engine='xlsxwriter')
...
for site in sites:
    ...
    stats.to_csv(f"../data/Statistiques_collections_2025_TMP2_{site['code']}.csv")
    
    print("---- tx")
    stats['evolution_prets_2023-2024'] = (stats['nb_prets_2024'] - stats['nb_prets_2023']) / stats['nb_prets_2023']
    stats['evolution_prets_2023-2025'] = (stats['nb_prets_2025'] - stats['nb_prets_2023']) / stats['nb_prets_2023']
    stats['evolution_prets_2024-2025'] = (stats['nb_prets_2025'] - stats['nb_prets_2024']) / stats['nb_prets_2024']
    ...
    stats['evolution_prets_exemplaires_distincts_2023-2025'] = (stats['nb_prets_exemplaires_distincts_2025'] - stats['nb_prets_exemplaires_distincts_2023']) / stats['nb_prets_exemplaires_distincts_2023']
    stats['evolution_prets_exemplaires_distincts_2024-2025'] = (stats['nb_prets_exemplaires_distincts_2025'] - stats['nb_prets_exemplaires_distincts_2024']) / stats['nb_prets_exemplaires_distincts_2024']
    
    stats['tx_rotation'] = round( stats['nb_prets_2025'] / stats['nb_exemplaires_empruntables'], 1)
    stats['tx_fond_actif'] =  stats['nb_prets_exemplaires_distincts_2025'] / stats['nb_exemplaires_empruntables']
    ...
    stats['evolution_emprunteurs_distincts_2023-2025'] = (stats['nb_emprunteurs_distincts_2025'] - stats['nb_emprunteurs_distincts_2023']) / stats['nb_emprunteurs_distincts_2023']
    stats['evolution_emprunteurs_distincts_2024-2025'] = (stats['nb_emprunteurs_distincts_2025'] - stats['nb_emprunteurs_distincts_2024']) / stats['nb_emprunteurs_distincts_2024']
    ...
    stats = stats[['nb_exemplaires', 'nb_exemplaires_empruntables', 'exemplaires_consultables_sur_place',
                   ...
                   'nb_exemplaires_elimines_abimes', 'nb_exemplaires_elimines_desherbes', 'nb_prets_2023',
                   'nb_prets_exemplaires_distincts_2023', 'nb_prets_2024', 'nb_prets_exemplaires_distincts_2024', 'nb_prets_2025',
                   'nb_prets_exemplaires_distincts_2025', 'nb_exemplaires_empruntables_pas_empruntés_1_an',
                   'nb_exemplaires_empruntables_pas_empruntés_3_an', 'nb_exemplaires_en_pret', 'evolution_prets_2023-2024',
                   'evolution_prets_2023-2025', 'evolution_prets_2024-2025', 'evolution_prets_exemplaires_distincts_2023-2024',
                   'evolution_prets_exemplaires_distincts_2023-2025', 'evolution_prets_exemplaires_distincts_2024-2025', 'tx_rotation',
                   'tx_fond_actif', 'tx_collection_non_empruntee_3_ans', 'tx_sortie', 'tx_non_restitues', 'tx_renouvellement',
                   'tx_accroissement', 'nb_emprunteurs_distincts_2023', 'nb_emprunteurs_distincts_2024', 'nb_emprunteurs_distincts_2025',
                   'evolution_emprunteurs_distincts_2023-2024', 'evolution_emprunteurs_distincts_2023-2025',
                   'evolution_emprunteurs_distincts_2024-2025']]
    ...
    stats.columns = ["exemplaires", "exemplaires empruntables", "exemplaires consultables sur place uniquement", "exemplaires en accès libre",
                     ...
                     "exemplaires éliminés non restitués", "exemplaires éliminés perdus", "exemplaires éliminés abîmés", "exemplaires éliminés désherbés", "prêts 2023",
                     "prêts 2023 exemplaires distincts", "prêts 2024", "prêts 2024 exemplaires distincts", "prêts 2025", "prêts 2025 exemplaires distincts",
                     "exemplaires empruntables pas empruntés 1 an", "exemplaires empruntables pas empruntés 3 ans", "exemplaires en prêt", "évolution prêts 2023-2024",
                     "évolution prêts 2023-2025", "évolution prêts 2024-2025", "évolution exemplaires distincts prêtés 2023-2024", "évolution exemplaires distincts prêtés 2023-2025",
                     "évolution exemplaires distincts prêtés 2024-2025", "taux de rotation", "taux de fonds actif", "part collection non empruntée depuis 3 ans", "taux de sortie",
                     "taux de non restitués", "taux renouvellement", "taux d'accroissement", "emprunteurs distincts 2023", "emprunteurs distincts 2024", "emprunteurs distincts 2025",
                     "évolution emprunteurs distincts 2023-2024", "évolution emprunteurs distincts 2023-2025", "évolution emprunteurs distincts 2024-2025"]
